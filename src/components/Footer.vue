          ...
          <div class="col-lg-4 col-sm-6 col-6 aos-item">
            <div class="widget widget_services">
              ...
              <ul>
                ...
                <li><a href="https://thinkhomestorage.blob.core.windows.net/realestateproperties/giornalino/rivista-thinkhome.pdf" download="rivista" target="_blank"><h6>Scarica rivista</h6></a></li>
              </ul>
            </div>
          </div>
          <div class="col-lg-4 col-sm-6 col-6 aos-item">
