<template>
  <div class="page-content bg-white">
    <CommonBanner :img="bnr5" title="Investimenti Immobiliari" text="Investimenti Immobiliari" />
        ...
        <div class="row align-items-center about-bx4">
          <div class="col-lg-6 m-b30 aos-item aos-init aos-animate">
            <div class="section-head style-2">
              ...
              <h2 class="title m-b20">Investimenti Immobiliari</h2>
               <p>•	Consulenza per acquisti all’asta</p>
               <p>•	Analisi di mercato immobiliare</p> 
               <p>•	Gestione e valorizzazione del patrimonio immobiliare</p>
               <p>•	Acquisizione e sviluppo di immobili a reddito</p>
          ...
          <div class="col-lg-6 m-b30">
            <div class="dz-media">
              <img
                src="@/assets/images/banner/bnr14.jpg"
                alt=""
