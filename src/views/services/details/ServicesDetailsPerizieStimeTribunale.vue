<template>
  <div class="page-content bg-white">
    <CommonBanner :img="bnr5" title="Perizie, Stime e Tribunale" text="Perizie, Stime e Tribunale" />
      ...
      <div class="container">
        <div class="row align-items-center about-bx4">
          <div class="col-lg-6 m-b30 aos-item aos-init aos-animate">
            <div class="section-head style-2">
              ...
              <h2 class="title m-b10">Perizie, Stime e Tribunale</h2>
               ...
               <p>•	Consulenza tecnica d'ufficio (CTU)</p>
               <p>•	Consulenza tecnica di parte (CTP)</p>
               <p>•	Assistenza nelle esecuzioni immobiliari</p>
            </div>
          ...
          <div class="col-lg-6 m-b30">
            <div class="dz-media">
              <img
                src="@/assets/images/banner/bnr25.jpg"
                alt=""
...
import bnr5 from '@/assets/images/banner/bnr26.jpg'
