<template>
  <div class="page-content bg-white">
    <CommonBanner :img="bnr5" title="Pratiche Catastali" text="Pratiche Catastali" />
  </div>
        ...
        <div class="row align-items-center about-bx4">
          <div class="col-lg-6 m-b30 aos-item aos-init aos-animate">
            <div class="section-head style-2">
              ...
              <h2 class="title m-b20">Pratiche Catastali</h2>
               <p>•	Accatastamenti e variazioni catastali</p>
               <p>•	Volture catastali</p> 
               <p>•	Riconfinamenti catastali</p>
          ...
          <div class="col-lg-6 m-b30">
            <div class="dz-media">
              <img
                src="@/assets/images/banner/bnr10.jpg"
                alt=""
