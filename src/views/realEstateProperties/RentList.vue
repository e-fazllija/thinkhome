  ...
  methods: {
    async getItems(_page, _filter, _typologie, _location, _code, _from, _to) {
      ...
      const result = await axios.get(
        `https://thinkhomebe.azurewebsites.net/api/RealEstateProperty/GetMain?currentPage=${_page}&filterRequest=${_filter}&status=Affitto&typologie=${_typologie}&location=${_location}&code=${_code}&from=${_from}&to=${_to}`
      );
